...
<div class="row">
  ...
  <div class="col-md-7">
<p> <h2>Update Book Details</h2> </p>
<br/><br/>
<form class="form-horizontal" role="form" enctype="multipart/form-data" action="update_books" method="post">
...
<%
   ...
   String display_path="http://localhost/book/";
 	String dbUrl = "jdbc:mysql://localhost/libarary";
		...
		String query = "Select * FROM book_record where book_id="+id;
...
<div class="col-sm-5"> 
<input type="text" class="form-control" id="book_id" name="book_name" value="<%=id%>" readonly="true">
</div>
</div>
<div class="form-group">
...
<div class="form-group">			
	...
	<div class="col-sm-5">
            <input type="text" class="form-control" value="<%=rs.getString(3)%>" id="book_name" name="book_name" placeholder="Enter Book Name">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Book In Stock</label>
    <div class="col-sm-5">
        <input type="text" class="form-control" value="<%=rs.getString(4)%>" id="price" name="price" placeholder="Enter Price">
    </div>
  </div>

<div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Book Issued</label>
    <div class="col-sm-5">
        <input type="text" class="form-control" value="<%=rs.getString(5)%>" id="issued" name="issued" placeholder="Enter Price">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
          ...
          <img src="<%=display_path+rs.getString(6)%>" id="advrts_img_prvw" alt="" class="cursor margin_top10" style="width:100px;height:100px" onClick="document.getElementById('advrts_img').click();">
          </div>
  </div>
                  <%
                } 
