...
<br>
 <div class="row">
    ...
    <div class="col-sm-1">Book Issued</div>
    <div class="col-sm-2">Image</div>
    <div class="col-sm-2">UPDATE DETAILS</div>
  </div>
<div class="row">
</div>
 <%
 ...
 String display_path="http://localhost/book/";  
 	...
 	String dbUrl = "jdbc:mysql://localhost/libarary";
		...
		while (rs.next())
                {
              id = rs.getInt(1);
              path = "admin_update_book_details1.jsp?a="+id;
		%>
    <div class="row">
    ...
    <div class="col-sm-1"><%=rs.getString(5)%></div>
    <div class="col-sm-2"><img src="<%=display_path+rs.getString(6)%>" height="100px" width="100px"></div>
    <div class="col-sm-2"><a href="<%=path%>">UPDATE DETAILS</a></div>
