...
@WebService(endpointInterface ="services.Email")

public class SmtpMail implements Email
{
public static String mailgone="no";
@Override
public String sendEmail(String email1, String sub, String msg1)
{
...
final String password1 = "12345@abc";
